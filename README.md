...
`$ git clone git@github.com:IndigoUnited/node-screpto.git && cd node-screpto && rm -rf .git`   
`$ npm install && mv config.dist.json config.json && mv scripts/package.dist.json scripts/package.json`
